...
final public class Plate implements Serializable, Comparable<Plate>  {
    ...
    static public String[] AppTags = new String[]{"asian","mexican","italian","indian","vegan","vegetarian","japanese","greek","chinese","american","spicy","sweet","salty","bitter","alcoholic","gluten","gluten free","cilantro","chocolate","fruits","cheese","melted cheese","tortilla","jalapeno","meat","guacamole","chicken","beef","schrimps","strawberry","cream","potatos","orange","banana","rice","curry","ketchup","chimichuri","eggplant","eggs","tuna","cream","whipped cream","berry","lettuce","onion","olives","tomato","cucumber","pepper","gauda","avocado","pizza","pasta","burger","borito","nachos","doritos","tacos","fries","sushi","ramen","salad","hummus","tahini","shnitzel","salsa"};
